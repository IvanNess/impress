            ...
            <div className={`footer-inner`}>
                <div className={`footer-logo`}>
                    <div className={`image-wrapper`}>
                        <Link to='/impress#start'>
                            <svg fill={color} id="Layer_1" data-name="Layer 1" width={152} height={72} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1793.65 510.35">
                                <title>impress</title>
                                ...
                                <rect className="cls-1" x="168.21" y="404.44" width="1591.65" height="39" rx="15" />
                                {/* <rect x="168.42" y="404.44" width="675.52" height="39" rx="15" /> */}
                                <circle className="cls-2" cx="791.21" cy="423.94" r="46.18" fill='#fff' stroke={color} strokeMiterlimit={10} strokeWidth='30px' />
                            </svg>
                        </Link>
                ...
                <div className={`footer-info`}>
                    <div className={`text-wrapper`}>
                        ...
                        свидетельство о госрегистрации № 192798029 от 04.04.2017
                    </div>
                </div>
            </div>
